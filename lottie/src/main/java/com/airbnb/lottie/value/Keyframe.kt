...
open class Keyframe<T> {
    ...
    constructor(
        composition: LottieComposition?,
        startValue: T?, endValue: T?,
        xInterpolator: Interpolator?, yInterpolator: Interpolator?, startFrame: Float, endFrame: Float?
    ) {
        this.composition = composition
        this.startValue = startValue
        this.endValue = endValue
    ...
    fun containsProgress(@FloatRange(from = 0.0, to = 1.0) progress: Float): Boolean {
