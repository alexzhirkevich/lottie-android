...
enum class AsyncUpdates {
    ...
    /**
     * Use the async update path. Refer to the docs for [AsyncUpdates] for more details.
     */
    ENABLED,

    /**
     * Do not use the async update path. Refer to the docs for [AsyncUpdates] for more details.
     */
    DISABLED,
}
